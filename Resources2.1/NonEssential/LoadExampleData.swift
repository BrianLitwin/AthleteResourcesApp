...
class ExampleData {
    ...
    func setup() {
        ...
        makeSet(increment: 1.8, day: 70)
        makeSet(increment: 0.8, day: 60)
        makeSet(increment: 1.9, day: 55)
        makeSet(increment: 1.1, day: 50)
        makeSet(increment: 1.2, day: 45)
        makeSet(increment: 2, day: 40)
        makeSet(increment: 3, day: 35)
        makeSet(increment: 1.5, day: 30)
        makeSet(increment: 1.0, day: 25)
        makeSet(increment: 2.3, day: 20)
        makeSet(increment: 2, day: 15)
        makeSet(increment: 1.0, day: 10)
        makeSet(increment: 2.9, day: 5)
        makeSet(increment: 0.2, day: 5)
        makeSet(increment: -31.7, day: 5, reps: 5, sets: 4)
        ...
        var Is = [ -3.1, -2.2, -1, 1 ,2, -0.4, -1.1, -1, 2.4, 5, 3, -4, 2, 2.4, 1, 3, -4, 2, -0.1, 3, -2, 1, -1.1, 2.2, -1, -0.1, 3, -2, 1, -1.1, 2.2, -1, 3,2, 2.4, -1.1, -4, -3, -6, 4,2, -0.1, 3, -2.3, 1, -1.1, -2, 2.1, -1, 3,2, -0.45, -1.1, 0.8, 3,2, 2.4, -1.5, -4, -3, -5, 4, 2, -0.1, 3, -2, 1, -1.1, -2.2, -1, 3,2, -0.4, -1.1, -1, 1.4].map {
    ...
    func makeSet(increment: Double, day: Int, reps: Double = 1, sets: Double = 1) {
        ...
        workout.exerciseMetricsSet.first!.repsSV = reps
        workout.exerciseMetricsSet.first!.setsSV = sets
    }
